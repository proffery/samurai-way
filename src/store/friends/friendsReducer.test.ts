...
import {
    ...
    setFriendsPage,
    setPossibleFriends,
    setPossibleFriendsOnPage,
    setPossibleFriendsPage,
    setPossibleTotalFriendsCount,
...
describe("Friends reducer", () => {
    ...
    it("users should corectly added to friends state", () => {
        ...
        expect(friendsReducer(startState, action).friends.users[1].photos.small).toBe(
            "https://example.com/user2_small.jpg",
        )
    })
    ...
    it("users should corectly added possible friends state", () => {
        ...
        expect(friendsReducer(startState, action).possibleFriends.users[1].photos.small).toBe(
            "https://example.com/user2_small.jpg",
        )
    })
