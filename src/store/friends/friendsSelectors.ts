...
export const selectTotalPossibleFriendsCount = (state: AppRootState): number =>
  state.friends.possibleFriends.totalUsersCount
export const selectPossibleFriendsOnPage = (state: AppRootState): number => state.friends.possibleFriends.usersOnPage
export const selectPossibleFriendsCurrentPage = (state: AppRootState): number =>
  state.friends.possibleFriends.currentPage
