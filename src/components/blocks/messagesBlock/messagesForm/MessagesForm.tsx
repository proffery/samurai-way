...
export const MessagesForm: React.FC<Props> = ({ addMessage, addAppAlert }) => {
  ...
  return (
    <S.Form onSubmit={formik.handleSubmit} onKeyDown={addMessageKeyboardHandler}>
      <Input
        as={"textarea"}
      ...
      />
      <FlexWrapper>
        <Button type={"submit"} variant={"primary"} disabled={!!formik.errors.message} ariaLabel={"Submit button"}>
          {"Send"}
        </Button>
      </FlexWrapper>
    </S.Form>
