    ...
    <S.Message>
      ...
      >
        ...
        <FlexWrapper direction="column" align="center" justify="center">
          ...
          <S.Name>{messageData.senderId === authId ? messageData.senderName : messageData.senderName}&nbsp;</S.Name>
        </FlexWrapper>
        <FlexWrapper direction="column" style={{ width: "100%" }}>
          ...
          <S.Text
            style={{ opacity: 0.3, color: `${theme.color.background.status_error}` }}
            justify={"center"}
            align={"center"}
          >
      ...
      <S.ButtonsWrapper>
        <S.OptionButton title="Undo" variant="link" onClick={() => restoreMessage(messageData.id)} ariaLabel="Undo">
          <Icon iconId="restore" />
        </S.OptionButton>
      </S.ButtonsWrapper>
    </S.Message>
